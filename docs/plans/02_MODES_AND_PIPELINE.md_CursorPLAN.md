...
*Hinweis zur Nummerierung:* In der Anfrage kam „Cycle 01“ für diese Spec vor; als zweites Inkrement nach dem Lifecycle-Plan wird dieser Umsetzungszyklus hier **Cycle 02** genannt.
...
*Hinweis:* Konkrete Pfade (`api_post_multipart`) und Auth-Header sind an den **E2E-Runner** und die **tatsächliche API** anzupassen (siehe `e2e-runner/src/`).
...
*(Hinweis: Ein „Sound“ kann in deiner Umgebung nicht abgespielt werden; bitte bei Bedarf eine Benachrichtigung am Gerät auslösen.)*
